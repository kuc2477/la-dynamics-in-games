...
class Extragradient(Optimizer):
    ...
    """
    def __init__(self, params, defaults, eta=None):
    ...
    def extrapolation(self):
        ...
        for group in self.param_groups:
            for p in group['params']:
                u = self.update(p, group, lr=self.eta, momentum=0)
                if is_empty:
...
class ExtraSGD(Extragradient):
    ...
    """
    def __init__(self, params, lr=required, momentum=0, dampening=0, eta=None,
    ...
    def update(self, p, group, lr=None, momentum=None):
        weight_decay = group['weight_decay']
        momentum = group['momentum'] if momentum is None else momentum
